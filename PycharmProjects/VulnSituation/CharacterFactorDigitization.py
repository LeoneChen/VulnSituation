...
def character_factor_digitization(src_path, dst_path):
    ...
    Repository.init_workbook(dst_path,
                             ['CVE ID', 'Year', 'Interval', 'CWE ID', 'Level', 'Score', 'Attack Vector',
...
if __name__ == '__main__':
    character_factor_digitization(
        r'C:\Users\陈力恒\Downloads\NVD\Linux Kernel Character Factor(Middle).xls',
        r'C:\Users\陈力恒\Downloads\NVD\Linux Kernel Character Factor(Middle)(Digit).xls'
    )
